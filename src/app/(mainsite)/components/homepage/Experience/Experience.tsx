 ...
 <div className={styles.experience}>
    ...
    <div className={styles.itemsWrapper}>
        <div className={styles.item}>
            ...
            <p className={styles.desc}>Tell us what kind of help you need</p>
         ...
         <div className={styles.item}>
            ...
            <h3 className={styles.title}>Find Your Fit</h3>
            <p className={styles.desc}>We’ll connect you with the right professional</p>
         ...
         <div className={styles.item}>
            ...
            <h3 className={styles.title}>Relax</h3>
            <p className={styles.desc}>Enjoy peace of mind with our support</p>
        </div>
    </div>
