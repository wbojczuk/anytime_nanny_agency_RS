...
import { Lora, Italiana } from 'next/font/google'
...
const primaryFont = Lora({ subsets: ['latin'], weight: ["400", "500", "600", "700"], display: "swap", variable: "--primary-font" })
const secondaryFont = Italiana({ subsets: ['latin'], weight: ["400"], display: "swap", variable: "--secondary-font" })
